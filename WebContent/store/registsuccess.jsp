...
<script type="text/javascript" src="${pageContext.request.contextPath }/store/js/my.js">
				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								...
								<br /> <a href="${pageContext.request.contextPath }/store/store_login.jsp"><span id="second">5</span>秒后自动为您转跳回登录界面</a>
							</td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
